...
const EmploymentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const participantData = {
      ...
      supportProvided: {
        assessment_hoursSpent: formData.supportProvided_Assessment_hoursSpent,
        planning_and_reviewing_progress_hoursSpent: formData.supportProvided_Planning_and_reviewing_progress_hoursSpent,
        exploring_employment_options_hoursSpent: formData.supportProvided_Exploring_employment_options_hoursSpent,
        engagement_with_family_hoursSpent: formData.supportProvided_Engagement_with_family_hoursSpent,
        engagement_with_professionals_hoursSpent: formData.supportProvided_Engagement_with_professionals_hoursSpent,
        building_social_skills_progressTowardsMilestone: formData.supportProvided_Building_social_skills_progressTowardsMilestone,
        building_social_skills_hoursSpent: formData.supportProvided_Building_social_skills_hoursSpent,
        travel_training_progressTowardsMilestone: formData.supportProvided_Travel_training_progressTowardsMilestone,
        travel_training_hoursSpent: formData.supportProvided_Travel_training_hoursSpent,
        work_skill_training_progressTowardsMilestone: formData.supportProvided_Work_skill_training_progressTowardsMilestone,
        work_skill_training_hoursSpent: formData.supportProvided_Work_skill_training_hoursSpent,
        employer_engagement_progressTowardsMilestone: formData.supportProvided_Employer_engagement_progressTowardsMilestone,
        employer_engagement_hoursSpent: formData.supportProvided_Employer_engagement_hoursSpent,
        work_experience_support_progressTowardsMilestone: formData.supportProvided_Work_experience_support_progressTowardsMilestone,
        work_experience_support_hoursSpent: formData.supportProvided_Work_experience_support_hoursSpent,
        on_the_job_support_progressTowardsMilestone: formData.supportProvided_On_the_job_support_progressTowardsMilestone,
        on_the_job_support_hoursSpent: formData.supportProvided_On_the_job_support_hoursSpent,
        other_activity_description: formData.supportProvided_Other_activity_description,
        other_progressAchieved: formData.supportProvided_Other_progressAchieved,
        other_hoursSpent: formData.supportProvided_Other_hoursSpent,
        additional_notes: formData.supportProvided_Additional_notes,
      },
      totalSupportHours: {
        totalHours: formData.totalSupportHours_totalHours,
        oneToOnePercentage: formData.totalSupportHours_oneToOnePercentage,
        groupBasedPercentage: formData.totalSupportHours_groupBasedPercentage,
        distanceOnlinePercentage: formData.totalSupportHours_distanceOnlinePercentage,
        totalPercentage: formData.totalSupportHours_totalPercentage,
      },
      finalOutcome: {
        continueSupportNextPeriod: formData.finalOutcome_continueSupportNextPeriod,
        outcomeAtExit: formData.finalOutcome_outcomeAtExit,
        exitDate: formData.finalOutcome_exitDate,
        exitNotes: formData.finalOutcome_exitNotes,
      },
      employmentDetails: {
        status: formData.employmentDetails_status,
        industry: formData.employmentDetails_industry,
        employerName: formData.employmentDetails_employerName,
        averageWeeklyHours: formData.employmentDetails_averageWeeklyHours,
        usingNDISSupportsInEmployment: formData.employmentDetails_usingNDISSupportsInEmployment,
        supportedWages: formData.employmentDetails_supportedWages,
        startDate: formData.employmentDetails_startDate,
        employmentNotes: formData.employmentDetails_employmentNotes,
      }
    };
